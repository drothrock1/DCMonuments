...
- (void)viewDidLoad {
	...
	NSDictionary *row1 = [[NSDictionary alloc] initWithObjectsAndKeys:@"1. White House", @"Name", @"1600 Pennsylvania Avenue NW",@"Address",@"table1",@"Image", nil];
	NSDictionary *row2 = [[NSDictionary alloc] initWithObjectsAndKeys:@"2. Washington Monument", @"Name", @"Constitution Ave and 15th Street NW",@"Address",@"table2",@"Image",  nil];	
	NSDictionary *row3 = [[NSDictionary alloc] initWithObjectsAndKeys:@"3. World War II Memorial", @"Name", @"Constitution Ave and 17th Street NW",@"Address",@"table3",@"Image",  nil];	
	NSDictionary *row4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"4. Vietnam Veterans Memorial", @"Name", @"Constitution Ave and 21st Street NW",@"Address",@"table4",@"Image",  nil];	
	NSDictionary *row5 = [[NSDictionary alloc] initWithObjectsAndKeys:@"5. Albert Einstein Memorial", @"Name", @"2101 Constitution Ave NW",@"Address",@"table5",@"Image",  nil];	
	NSDictionary *row6 = [[NSDictionary alloc] initWithObjectsAndKeys:@"6. Lincoln Memorial", @"Name", @"Constitution Ave and 23rd Street NW",@"Address",@"table6",@"Image",  nil];	
	NSDictionary *row7 = [[NSDictionary alloc] initWithObjectsAndKeys:@"7. Korean War Memorial", @"Name", @"Independence Ave and Ohio Drive SW",@"Address",@"table7",@"Image",  nil];
	NSDictionary *row8 = [[NSDictionary alloc] initWithObjectsAndKeys:@"8. MLK Memorial", @"Name", @"Independence Ave and Ohio Drive SW",@"Address",@"table8",@"Image",  nil];
	NSDictionary *row9 = [[NSDictionary alloc] initWithObjectsAndKeys:@"9. FDR Memorial", @"Name", @"Ohio Drive SW and West Basin Drive SW",@"Address",@"table9",@"Image",  nil];	
	NSDictionary *row10 = [[NSDictionary alloc] initWithObjectsAndKeys:@"10. Jefferson Memorial", @"Name", @"Ohio Drive and 14th Street SW",@"Address",@"table10",@"Image",  nil];	
	NSDictionary *row11 = [[NSDictionary alloc] initWithObjectsAndKeys:@"11. US Capitol Building", @"Name", @"Independence Ave and First Street SW",@"Address",@"table11",@"Image",  nil];	
